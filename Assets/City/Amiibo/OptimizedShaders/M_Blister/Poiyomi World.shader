Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/1c54c9f4e2cbe56498c4d1e77f836ea7"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_REALISTIC 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,1,1,0.05490196).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(1,1,1,0.05490196).a;
