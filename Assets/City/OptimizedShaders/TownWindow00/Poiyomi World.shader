Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/51189545947776346bcf009f9e6ad532"
{
	Properties
	{
 ...
 #define PROP_MOCHIEMETALLICMAPS 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,1,1,0.5529412).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(1,1,1,0.5529412).a;
