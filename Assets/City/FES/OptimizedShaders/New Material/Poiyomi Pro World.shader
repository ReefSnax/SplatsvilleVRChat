Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro World/911198e35cb390e46af9400a897cd796"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_FLAT 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float4 mainTexture = UNITY_SAMPLE_TEX2D(_MainTex, poiUV(mainUV, float4(100,100,0,0)) + _Time.x * float4(0,0,0,0));
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,1,1,0.09803922).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(1,1,1,0.09803922).a;
