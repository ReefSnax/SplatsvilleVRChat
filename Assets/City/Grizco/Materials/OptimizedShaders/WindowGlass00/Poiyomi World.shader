Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/2a03c189f87285e4f8d6b586a4de4e83"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_REALISTIC 
			...
			{
				float smoothness = float(0.866);
				float smoothness2 = float(1);
				float metallic = float(0.263);
