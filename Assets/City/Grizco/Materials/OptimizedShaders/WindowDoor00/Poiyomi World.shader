Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/203cab60a32c8e64bafeeeb246849862"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_REALISTIC 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.0487818,0.07984675,0.1114872,1).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(0.0487818,0.07984675,0.1114872,1).a;
