Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/287d26eecce4809498e725e3e47fa8df"
{
	Properties
	{
 ...
 #define PROP_EMISSIONMAP 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,0,0,1).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(1,0,0,1).a;
