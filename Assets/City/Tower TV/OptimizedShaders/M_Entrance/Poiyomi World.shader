Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/e095babee73af1c42a7b70dcf48e9b16"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_REALISTIC 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.01219615,0.01219615,0.01219615,1).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(0.01219615,0.01219615,0.01219615,1).a;
