Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/56855d58291511a47901551ef26d6dc8"
{
	Properties
	{
 ...
 #define PROP_FLIPBOOKTEXARRAY 
			...
			{
				#if defined(PROP_DETAILTEX) || !defined(OPTIMIZER_ENABLED)
				half3 detailTexture = POI2D_SAMPLER_PAN(_DetailTex, _MainTex, poiUV(poiMesh.uv[float(0)], float4(100,100,0,0)), float4(0,0,0,0)).rgb * poiThemeColor(poiMods, float4(1,1,1,1), float(0));
				#else
