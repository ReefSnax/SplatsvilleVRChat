Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/331ab92c0a900d34c84218a447bc7fd5"
{
	Properties
	{
 ...
 #define PROP_MOCHIEMETALLICMAPS 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.5299,0.5299,0.5299,1).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(0.5299,0.5299,0.5299,1).a;
