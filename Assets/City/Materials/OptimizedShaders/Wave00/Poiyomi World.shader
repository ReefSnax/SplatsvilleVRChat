Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/9d625704a4345cd45b7016a6375bb393"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_REALISTIC 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.06955751,0.06955751,0.06955751,1).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(0.06955751,0.06955751,0.06955751,1).a;
