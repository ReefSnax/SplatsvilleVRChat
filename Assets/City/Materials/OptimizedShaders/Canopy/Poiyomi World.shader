Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/5d0d58ee45b09b94997be40f179ceb09"
{
	Properties
	{
 ...
 #define PROP_MOCHIEMETALLICMAPS 
			...
			{
				poiFragData.alpha = saturate(poiFragData.alpha + float(0.41));
			}
