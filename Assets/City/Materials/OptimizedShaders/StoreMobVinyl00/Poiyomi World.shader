Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/3ba1d008fc2d03b46aac90dedbb734de"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_REALISTIC 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,1,1,0.0627451).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(1,1,1,0.0627451).a;
