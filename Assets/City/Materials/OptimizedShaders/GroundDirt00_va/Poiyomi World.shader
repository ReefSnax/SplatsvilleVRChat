Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/a1b6cccb6a1de9f4d92a282c251fa99a"
{
	Properties
	{
 ...
 #define PROP_MOCHIEMETALLICMAPS 
			...
			void applyVertexColor(inout PoiFragData poiFragData, PoiMesh poiMesh)
			{
				if (float(1))
				{
					...
					float3 vertCol = lerp(poiMesh.vertexColor.rgb, GammaToLinearSpace(poiMesh.vertexColor.rgb), float(0));
