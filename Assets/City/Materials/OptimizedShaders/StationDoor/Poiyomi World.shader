Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/73f5f9034c1adcc43bc9ceddee5c7989"
{
	Properties
	{
 ...
 #define PROP_MOCHIEMETALLICMAPS 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.09441278,0.09441278,0.09441278,1).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(0.09441278,0.09441278,0.09441278,1).a;
