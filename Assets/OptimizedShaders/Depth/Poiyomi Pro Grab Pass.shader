Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro Grab Pass/7e487e1cb0a865140919167cb959218a"
{
	Properties
	{
		...
		[HideInInspector] m_grabPassCategory ("Grab Pass--{button_help:{text:Tutorial,action:{type:URL,data:https://www.poiyomi.com/grab-pass/grabpass},hover:Documentation}", Float) = 0
 ...
 #define _LIGHTINGMODE_FLAT 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0,0,0,0.8156863).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(0,0,0,0.8156863).a;
