Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi World/c609c122186c94e48b2dd53b4acded59"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_FLAT 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,1,1,0.02745098).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(1,1,1,0.02745098).a;
