Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro World/ad1a81b6c7f738941aefc1c24273c362"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_REALISTIC 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,1,1,0.007843138).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(1,1,1,0.007843138).a;
