Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro World/2bb88f6958a2cfb4392ae7087e2d00cf"
{
	Properties
	{
 ...
 #define PROP_MOCHIEMETALLICMAPS 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.6562665,0.04425246,0.03810041,1).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(0.6562665,0.04425246,0.03810041,1).a;
