Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro World/603f7b61ab2dee24392a8743ced221db"
{
	Properties
	{
 ...
 #define PROP_MOCHIEMETALLICMAPS 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,0.3065684,0.6183187,1).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(1,0.3065684,0.6183187,1).a;
