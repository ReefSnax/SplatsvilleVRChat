Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro World/7b4db6e7658ed3042975f9706e5f11ec"
{
	Properties
	{
 ...
 #define PROP_MOCHIEMETALLICMAPS 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.003545147,0.7433497,0.7136709,1).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(0.003545147,0.7433497,0.7136709,1).a;
