Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro World/76a935c9680c9f3489a208cebef45628"
{
	Properties
	{
 ...
 #define PROP_MOCHIEMETALLICMAPS 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.5036157,0.03820435,0.6583748,1).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(0.5036157,0.03820435,0.6583748,1).a;
