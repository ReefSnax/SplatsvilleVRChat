Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro World/b9dd2ba4e80c5384bbcd0a0b1b90a756"
{
	Properties
	{
 ...
 #define PROP_MOCHIEMETALLICMAPS 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.08393916,0.08393916,0.08393916,1).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(0.08393916,0.08393916,0.08393916,1).a;
