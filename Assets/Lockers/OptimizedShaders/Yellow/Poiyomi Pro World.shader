Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro World/2c24cd34d17271a47b227d7ec406de3e"
{
	Properties
	{
 ...
 #define PROP_MOCHIEMETALLICMAPS 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.9274173,1,0,1).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(0.9274173,1,0,1).a;
