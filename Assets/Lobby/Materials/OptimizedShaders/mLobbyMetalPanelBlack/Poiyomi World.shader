Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/96ab49debc6680944ac09fceb9ad1ae4"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_REALISTIC 
			...
			{
				float smoothness = float(0.539);
				float smoothness2 = float(1);
				float metallic = float(0.121);
