Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/abc5c71df17e74d4dbe630bc9754a6a2"
{
	Properties
	{
 ...
 #define PROP_MOCHIEMETALLICMAPS 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.0317027,0.04036139,0.04193994,1).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(0.0317027,0.04036139,0.04193994,1).a;
				...
				clip(poiFragData.alpha - float(0.121));
