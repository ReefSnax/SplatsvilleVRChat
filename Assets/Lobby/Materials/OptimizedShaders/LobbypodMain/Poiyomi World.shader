Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/0d58efe4d46c96f43934fe8ac73e0354"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_REALISTIC 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.5754442,0.5754442,0.5754442,1).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(0.5754442,0.5754442,0.5754442,1).a;
