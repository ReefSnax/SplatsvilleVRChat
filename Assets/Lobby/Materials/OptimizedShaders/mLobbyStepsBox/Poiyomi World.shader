Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/411ec6ac0feacee44bdf077af8e5b3d6"
{
	Properties
	{
 ...
 #define PROP_EMISSIONMAP 
			...
			{
				float3 emission0 = 0;
				float emissionStrength0 = float(0.7);
			...
			{
				float smoothness = float(0.153);
				float smoothness2 = float(1);
				float metallic = float(0.17);
