Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/039f5dea11ceab94982f15705f6fa4d1"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_REALISTIC 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.01574108,0.01574108,0.01574108,1).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(0.01574108,0.01574108,0.01574108,1).a;
