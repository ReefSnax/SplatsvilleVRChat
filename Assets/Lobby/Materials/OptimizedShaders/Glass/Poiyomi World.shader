Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/16bdc67eff3c58046b3d78c9aa6eb6d7"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_FLAT 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.4204631,0.9500899,0.957614,0.007843138).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(0.4204631,0.9500899,0.957614,0.007843138).a;
