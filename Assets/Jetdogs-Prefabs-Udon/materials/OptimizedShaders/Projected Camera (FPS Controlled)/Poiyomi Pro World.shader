Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro World/1ecf51da42cd01d47a059fa54ad87813"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_FLAT 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if (float(0))
				{
					mainUV = sharpSample(float4(0.00078125,0.001388889,1280,720), mainUV);
				}
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,1,1,0.8784314).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(1,1,1,0.8784314).a;
