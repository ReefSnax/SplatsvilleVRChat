Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/cde9edb867fdec14a9206ff2458088c1"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_REALISTIC 
			...
			{
				float clearCoatMask = float(0.439);
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,1,1,0.05098039).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(1,1,1,0.05098039).a;
