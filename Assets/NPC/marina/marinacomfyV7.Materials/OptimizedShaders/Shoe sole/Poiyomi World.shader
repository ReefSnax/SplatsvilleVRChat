Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/0970eab76073b8a4d8c232111953f319"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_REALISTIC 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.009166705,0.009166705,0.009166705,1).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(0.009166705,0.009166705,0.009166705,1).a;
