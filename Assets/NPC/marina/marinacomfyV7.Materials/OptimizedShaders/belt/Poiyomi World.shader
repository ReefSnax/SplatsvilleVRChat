Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/9d7c131b25b098c4b8386562e37a83e5"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_REALISTIC 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.006628765,0.006628765,0.006628765,1).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(0.006628765,0.006628765,0.006628765,1).a;
