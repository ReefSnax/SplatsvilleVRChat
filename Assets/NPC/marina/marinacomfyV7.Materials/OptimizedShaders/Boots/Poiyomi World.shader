Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/fb9e1826d2478ca45a1fb6c4e23d2e8c"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_REALISTIC 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.01219614,0.01219614,0.01219614,1).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(0.01219614,0.01219614,0.01219614,1).a;
