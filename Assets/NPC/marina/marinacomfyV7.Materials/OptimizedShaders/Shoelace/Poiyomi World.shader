Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/b436923417d9164428a82132eddc270c"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_REALISTIC 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.03550514,0.03455936,0.03455936,1).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(0.03550514,0.03455936,0.03455936,1).a;
