Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi World/7f9eeb179f1b965449a6ffddd380d14b"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_REALISTIC 
			...
			void applySubsurfaceScattering(in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh)
			{
				...
				float SSS = 1;
				#endif
				float3 vLTLight = poiLight.direction + poiMesh.normals[0] * float(0.564);
