Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi World/536bda8dfd4cb504eb8f8221ea68021b"
{
	Properties
	{
 ...
 #define PROP_MOCHIEMETALLICMAPS 
			...
			void applySubsurfaceScattering(in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh)
			{
				...
				#endif
				poiLight.finalLightAdd += fLT * poiLight.directColor * float4(1,1,1,1) * poiLight.attenuation;
			}
			#endif
