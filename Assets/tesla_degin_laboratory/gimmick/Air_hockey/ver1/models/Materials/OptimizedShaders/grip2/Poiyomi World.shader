Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/a28bf59ca3142b341ab34a7367477ab4"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_REALISTIC 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.113175,0,1,1).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(0.113175,0,1,1).a;
