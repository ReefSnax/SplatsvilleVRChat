Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/9a520abbb95f90a4a8528ee6a84fdd64"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_REALISTIC 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.4175291,1,0,1).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(0.4175291,1,0,1).a;
