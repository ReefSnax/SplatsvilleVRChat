Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro World/374e12257b978bf47ae2bce96b9d85b3"
{
	Properties
	{
 ...
 #define PROP_MOCHIEMETALLICMAPS 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,1,1,0.4980392).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(1,1,1,0.4980392).a;
